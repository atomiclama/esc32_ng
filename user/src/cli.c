...
const cliCommand_t cliCommandTable[] = { { "arm", "", cliFuncArm }, { "beep", "<frequency> <duration>", cliFuncBeep }, {
        "binary", "", cliFuncBinary }, { "bootloader", "", cliFuncBoot }, { "config", "[READ | WRITE | DEFAULT]",
        cliFuncConfig }, { "disarm", "", cliFuncDisarm }, { "duty", "<percent>", cliFuncDuty }, { "help", "",
        cliFuncHelp }, { "input", "[PWM | UART | I2C | CAN]", cliFuncInput }, { "mode",
        "[OPEN_LOOP | RPM | THRUST | SERVO]", cliFuncMode }, { "pos", "<degrees>", cliFuncPos }, { "pwm",
        "<microseconds>", cliFuncPwm }, { "rpm", "<target>", cliFuncRpm }, { "set", "LIST | [<PARAMETER> <value>]",
        cliFuncSet }, { "start", "", cliFuncStart }, { "status", "", cliFuncStatus }, { "stop", "", cliFuncStop }, {
        "telemetry", "<Hz>", cliFuncTelemetry }, { "version", "", cliFuncVer } };

#define CLI_N_CMDS (sizeof cliCommandTable / sizeof cliCommandTable[0])

const char *cliInputModes[] = { "PWM", "UART", "I2C", "CAN", "OW" };

const char *cliStates[] = { "DISARMED", "STOPPED", "PRE-START", "STARTING", "RUNNING" };

const char *cliRunModes[] = { "OPEN_LOOP", "RPM", "THRUST", "SERVO" };
